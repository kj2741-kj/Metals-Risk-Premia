...
# This page lives in dashboard_v2/, one level below the repo root where data/
# actually is -- every local-file path below must go up one directory.
_REPO_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# Page config + global CSS theme are set once by app.py (the multi-page entry
# point) before routing here — not repeated in this page module.
...
LOCAL_CASH_PATH = os.path.join(_REPO_ROOT, "data", "Metals Cash and 3M.xlsx")
LOCAL_CURVE_PATH = os.path.join(_REPO_ROOT, "data", "Metals Futures Curve.csv")
...
LOCAL_F1_CONT_PATH = os.path.join(_REPO_ROOT, "data", "LME_Copper_Rolling_F1_v2.csv")
LOCAL_AL_F1_PATH   = os.path.join(_REPO_ROOT, "data", "LME_Aluminium_Rolling_F1_v2.csv")
...
_MA_OPT_PATH  = os.path.join(_REPO_ROOT, "data", "MA_Crossover_Optimization.csv")
_CTA_OPT_PATH = os.path.join(_REPO_ROOT, "data", "CTA_Optimization.csv")
