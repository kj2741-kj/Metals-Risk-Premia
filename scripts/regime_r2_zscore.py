...
carry_pos  = np.sign(zsc).shift(1).reindex(f1c.index).fillna(0)  # Z-score-252d variant for comparison
...
print("=" * 118)
print("R2 -- IS-OPTIMISED VOL-REGIME WEIGHTS (Mom MA(20,45) / Carry Z-score-252d / Value V1 F8), walk-forward, net 5bps")
